/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 5b9decbfe489b51b8709e95278aa3bfb)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		GOOGLE_JWT_PRIVATE_KEY_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_JWT_PRIVATE_KEY" | "GOOGLE_JWT_PRIVATE_KEY_ID" | "GOOGLE_JWT_EMAIL">> {}
}
